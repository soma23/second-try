    ...
    <!---Room1--->   
            ...
            <fieldset>
        		<div class="form-group">
    				<label class="col-md-4 control-label" for="RName">Room Name:</label>
    					<div class="col-md-8">
    						<input id="roomName" name="rname" type="text" class="form-control" readonly>
    					</div>
    			</div><!--/.form-group-->
        		...
        		<div class="form-group">
    				<label class="col-md-4 control-label" for="Description">Description:</label>
    					<div class="col-md-8">
    						<input id="description" name="description" type="text" class="form-control" readonly>
    					</div>
    			</div><!--/.form-group-->
              </fieldset>							
    		</form>
