...
<div class="container">
<!--sidebar-->
	<?php include('includes/Tips_sidebar.php'); ?>
<!--/.sidebar-->
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading box-header ">
                        ...
                        <div class="panel-body box-content small">
                            <li>Always call a certified electrician to do any wiring in your home.</li>
                            <br>
                            <li>Call the utility company before digging in your yard.</li>
                            <br>
                            <br>
                             <br>
                            <br>
