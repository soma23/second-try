...
<title>iTrack | Building Features</title>
...
<div class="row">
            ...
            &nbsp;
				...
				<li class="active">Building Features</li>
			</ol>
		</div><!--/.row-->
...
<div class="col-lg-9 col-sm-offset-2  main"> 	<!-- offset 2 -->						
 ...
 <!--</div><!--/.row-->    
								...
								<div class="form-group">
									...
									<div class="form-group">
										<label class="col-md-3 control-label" for="NumberOfRoom">Number Of Rooms:</label>
											<div class="col-md-9">
											<input id="numberOfRoom" name="numberOfRoom" type="number" class="form-control" >
										</div>
									</div><!--/.form-group-->
                              	</fieldset>								
								</form>
